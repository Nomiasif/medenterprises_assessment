...
# This class contains all the automated acceptance tests
class TestCases:
    ...
    def test_long_term_garage_parking_for_more_than_a_week(self):
        utils_obj = self.create_logic_class_instance()
        utils_obj.open_browser()
        utils_obj.navigate_to_page(self.url_to_navigate)
        utils_obj.select_parking_type("Long-Term Garage Parking")
        utils_obj.select_parking_date_time(parking_date="02/03/2023", parking_time="10:00" , parking_mode="Entry")
        utils_obj.select_time_mode("Entry","AM")
        utils_obj.select_parking_date_time(parking_date="02/10/2023", parking_time="05:00", parking_mode="Exit")
        utils_obj.select_time_mode("Exit", "PM")
        utils_obj.click_calculate_btn()
        resultant_cost = utils_obj.verify_result("$ 84.00")
        assert resultant_cost
        # Added this time.sleep just to show the assessment reviewer the desired result, otherwise there is no need of adding it
        time.sleep(2)
    ...
    def test_long_term_surface_parking_for_more_than_a_week(self):
        utils_obj = self.create_logic_class_instance()
        utils_obj.open_browser()
        utils_obj.navigate_to_page(self.url_to_navigate)
        utils_obj.select_parking_type("Long-Term Surface Parking")
        utils_obj.select_parking_date_time(parking_date="02/03/2023", parking_time="10:00" , parking_mode="Entry")
        utils_obj.select_time_mode("Entry","AM")
        utils_obj.select_parking_date_time(parking_date="02/10/2023", parking_time="04:00", parking_mode="Exit")
        utils_obj.select_time_mode("Exit", "PM")
        utils_obj.click_calculate_btn()
        resultant_cost = utils_obj.verify_result("$ 70.00")
        assert resultant_cost
        # Added this time.sleep just to show the assessment reviewer the desired result, otherwise there is no need of adding it
        time.sleep(2)
